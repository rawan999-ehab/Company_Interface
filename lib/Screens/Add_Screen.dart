          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                buildDropdownField("Internship Type", Icons.business_center, ["On-site", "Remote"], (value) => type = value!),
                buildTextField("Duration (e.g., 3 months)", Icons.access_time, (value) => duration = value!),
                buildTextField("Description", Icons.description, (value) => description = value!, maxLines: 3),
                SizedBox(height: 20),
                SizedBox(
